"""Unit tests for imBots.store SQLite persistence."""
...
class TestBotSessions:
    ...
    def test_get_nonexistent(self):
        from imBots.store import get_session
    ...
    def test_get_all_sessions(self):
        from imBots.store import save_session, get_all_sessions
    ...
    def test_update_status(self):
        from imBots.store import save_session, update_session_status, get_session
    ...
    def test_update_field_bot_token(self):
        from imBots.store import save_session, update_session_field, get_session
    ...
    def test_delete_session(self):
        from imBots.store import save_session, delete_session, get_session
        save_session("wechat")
...
class TestMessages:
    def test_save_and_get(self):
        from imBots.store import save_message, get_messages
        save_message(
    ...
    def test_get_context_token(self):
        from imBots.store import save_message, get_context_token
    ...
    def test_prune_old_messages(self):
        from imBots import store as store_mod
        from imBots.store import save_message, get_messages
